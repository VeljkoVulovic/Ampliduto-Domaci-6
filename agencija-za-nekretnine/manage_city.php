...
<body>
    <ul class="nav justify-content-center mt-2 mb-3">
        ...
        <li class="nav-item">
            <a class="nav-link active" href="./create_city.php"><b>Dodaj grad</b></a>
        </li>
    </ul>
    <div class="container">
    <table class="table table-striped table-bordered">
        ...
        <?php
            while($row = mysqli_fetch_assoc($result) ){
                $temp_id = $row['id'];
                $linkEdit = "<a href=\"edit_form_city.php?id=$temp_id\">Edit</a>";
                $linkDelete = "<a href=\"delete_city.php?id=$temp_id\">Delete</a>";
